...
# odds_data_excel = read_data('C:/Users/Darragh/Documents/Python/gaa/hurling_2023.xlsx',sheet_name='Odds',parse_dates=['Date'])
odds_data_excel = pd.read_excel('C:/Users/Darragh/Documents/Python/gaa/hurling_2023_python.xlsx',sheet_name='Odds',parse_dates=['Date'])
def csv_save(x):
    x.to_csv('C:/Users/Darragh/Documents/Python/gaa/hurling_2023_odds.csv')
    return x
csv_save(odds_data_excel)

data = read_csv_data('C:/Users/Darragh/Documents/Python/gaa/hurling_2023_odds.csv').copy()
...
team_names_id=pd.read_excel('C:/Users/Darragh/Documents/Python/gaa/hurling_2023_python.xlsx',sheet_name='ID')
...
cols_to_move=['Week','week_regression','Date','Home ID','Away ID','Home Team','Away Team','Spread','Home Points', 'Away Points',
              'Closing_Total', 'Home_Total_Points', 'Away_Total_Points']
...
with st.expander('Season to Date Cover Factor by Team'):
    ...
    def season_total_team(spread_3,updated_df):
        ...
        stdc_away=spread_3.rename(columns={'ID':'Away ID'})
        # stdc_away['cover_sign_total_team']=-stdc_away['cover_sign_total_team']
        # stdc_home['cover_sign_total_team']=-stdc_home['cover_sign_total']
...
with st.expander('Team Totals Cleaned UP and automated for every week'):
    ...
    base = alt.Chart(limerick_graph).mark_circle(color="black").encode(alt.X("Spread")), alt.Y("team_total_points"))
...
with placeholder_2.expander('Betting Slip Matches'):
    ...
    # st.write('#2 Merged correctly?', updated_df)
    ...
    def run_analysis(updated_df):
        ...
        betting_matches['over_under_factor']=betting_matches['home_cover_sign_total']+betting_matches['away_cover_sign_total']\
            +betting_matches['home_cover_sign_total_team']+betting_matches['away_cover_sign_total_team']
        ...
        betting_matches['bet_on_totals'] = np.where(betting_matches['over_under_factor']>min_factor,betting_matches['Home Team'],
                                             np.where(betting_matches['over_under_factor']<-min_factor,betting_matches['Away Team'],''))
        ...
        #               'away_cover_sign_total','home_cover_sign_total_team','home_power','away_cover_sign_total_team','away_power']
